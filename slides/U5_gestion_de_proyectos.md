...
![Bibliografia](images/u5-gest-proy/ian-sommerville-22.png)
...
---
![Gestión de Proyectos](images/u5-gest-proy/gestion-de-proyectos.jpg)

---

![Gestion de Proyectos](images/u5-gest-proy/caracteristicas-de-un-proyecto.jpg)
...
---
![Administración de Proyecto](images/u5-gest-proy/proyecto-administracion.jpg)

---
![Dirección de Proyectos](images/u5-gest-proy/direccion-de-proyectos.jpg)
...
---
![Fases del Proyecto](images/u5-gest-proy/fases-del-proyecto.jpg)
...
![Restricciones](images/u5-gest-proy/restricciones.jpg)
...
![Gestión del Riesgo](images/u5-gest-proy/gestion-del-riesgo.png)
...
### 1. IDENTIFICACIÓN DEL RIESGO: EJEMPLOS
<!-- .slide: style="font-size: 0.40em" -->
<!--
| Tipo de riesgo  | Riesgos posibles                                                                                                                                                                                                                                |
|:----------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Tecnología      | La base de datos que se usa en el sistema no puede procesar tantas transacciones por segundo como se esperaba. (1) <br> Los componentes de software de reutilización contienen defectos que haen que no puedan reutilizarse como se planeó. (2) |
| Personal        | Es imposible reclutar personal con las habilidades requeridas. (3) <br> El personal clave está enfermo e indispuesto en momentos críticos. (4) <br> No está disponible la capacitación requerida para el personal. (5)                          |
| De organización | La organización se reestructura de modo que diferentes adminsitraciones son responsables del proyecto. (6) <br> Problemas financieron de la organización fuerzan reducciones en el presupuesto del proyecto. (7)                                |
| Herramientas    | El código elaborado por las herramientas de generación de código de software es ineficiente. (8) <br> Las herramientas de software no pueden trabajar en una forma integrada. (9)                                                               |
| Requerimientos  | Se proponen cambios a los requerimientos que demandan mayor trabajo de rediseño. (10) <br> Los clientes no entienden las repercusiones de los cambios a los requerimientos. (11)                                                                |
| Estimación      | Se subestima el tiempo requerido para desarrollar el software. (12) <br> Se subestima la tasa de reparación de defectos. (13) <br> Se subestima el tamaño del software. (14)                                                                    |
-->
<table>
<thead>
<tr>
...
#### 1. IDENTIFICACIÓN DEL RIESGO - PESTEL

![Pestel](images/u5-gest-proy/PES.jpeg)

----

#### 1. IDENTIFICACIÓN DEL RIESGO - PESTEL

![Pestel](images/u5-gest-proy/TEL.jpeg)

----

#### 1. IDENTIFICACIÓN DEL RIESGO - Ejemplo PESTEL

![Ejemplo Pestel](images/u5-gest-proy/pestel-mercadoLibre.webp)
...
### 2. ANÁLISIS DEL RIESGO: Matriz

![Matriz de Riesgo](images/u5-gest-proy/matriz-riesgo.png)

----

### 2. ANÁLISIS DEL RIESGO: EJEMPLOS
<!-- .slide: style="font-size: 0.60em" -->
<!--
...
<td style="text-align:left">Alerte al cliente de dificultades potenciales y de la posibilidad de demoras.</td>
</tr>
<tr>
...
decidir si este riesgo se vuelve más o menos probable, y si las consecuencias se han vuelto más o menos graves.

----

### 4. MONITOREO DEL RIESGO: INDICADORES DE RIESGO

Factores que pueden ser útiles para valorar requerimientos: 
<!-- .slide: style="font-size: 0.60em" -->
<!--1
...
![QR](images/u5-gest-proy/QR.png)

Dividirse en grupos de 4 ó 5 personas y asignar: Severidad, Probabilidad y Nivel de Riesgo. Pensar en al menos 1 medida de control.
...
![Jerarquía de Necesidades Humanas](images/u5-gest-proy/jerarquia-necesidades-humanas.png)

---
### SATISFACCIÓN DE NECESIDADES
* En desarrollo de software las necesidades fisiológicas y de seguridad estan cubiertas. 
* Satisfacción de necesidades **sociales** 
  * Generar facilidades de comunicación;
  * Favorecer la comunicación informal 
