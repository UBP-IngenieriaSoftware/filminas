...
![Diagrama de secuencia: Ver información del paciente](images/u8-UML/diagrama_secuencia.jpg)

----

#### Diagrama de secuencia para la transferencia de datos
![Diagrama de secuencia: Transferencia de datos](images/u8-UML/diagrama_secuencia_transferencia_datos.jpg)
...
### Ejercicio
Crea un diagrama de secuencia para que el client eo el administrativo de reservas pueda cancelar una reserva en el hotel.
...
Emplear los siguientes **mensajes**:
- obtenerCliente(clienteId)
- cancelarReserva(reservaId, clienteId)
- Solicitar cancelación(reservaId)
- Error "No autorizado"
- cancelar(reservaId, motivo="cancelación tardía", penalizacion=0.5*tarifaNoche)
- calcularTarifaNoche(reserva.tipoHabitacion, reserva.fechaCheckIn)
- cargarPenalizacion(reserva.metodoPago, monto=0.5*tarifaNoche, nreferencia=reservaId)
- Cancelación registrada; penalización pendiente de cobro
