...
* Sin embargo, hay una serie de actividades genéricas comunes a todos los procesos
  ...
  3. La validación de requerimientos ;
  4. La gestión de requerimientos.
* En la práctica, IR es una actividad iterativa en el que se intercalan estos procesos.

---
### 1 y 2. Obtención de requerimientos
...
---
### 2. Problemas con el análisis de requerimientos
...
---
### REQUERIMIENTOS:
* **Verificabilidad:** Los requerimientos son verificables
