...
Las herramientas de la ingeniería de software proporcionan un apoyo automatizado o semiautomatizado para el 
**proceso** y los **métodos**. 

Se pueden integran de modo que la información creada por una pueda ser utilizada por otra.
...
Incluyen un conjunto de tareas como comunicación, análisis de requerimientos, modelación del diseño, construcción del programa, pruebas y apoyo. 

Los métodos incluyen actividades de modelación y otras técnicas descriptivas.

----

## Capa 3: Proceso

Define una estructura que debe establecerse para la obtención del software. 
Forma la base para el control de la administración de proyectos y establece el contexto en el que
...
La administración total de la calidad alimentan la cultura de mejora continua, y eso lleva 
al desarrollo de enfoques eficaces de la ingeniería de software.
