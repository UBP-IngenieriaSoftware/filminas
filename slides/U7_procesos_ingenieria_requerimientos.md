...
> Desarrollar el sistema cuesta 20 
> millones pero se estima que permitirá 
> ahorrar 5 millones por año.
...
Identificar los **actores** que interactuarán con el sistema, es decir, aquellas personas u otros sistemas que serán los orígenes o destinos de la información que consumirá o producirá el sistema a desarrollar y que forman su entorno.
...
1. Elaborar **ERS**, Especificación de Requerimientos de Software. Contiene:
- Descripción completa de las funcionalidades del sistema a desarrollar
- Describe el alcance del sistema, comportamiento y ejecución esperada 
- Define los requerimientos funcionales y no funcionales. 

----

#### ERS
Es el resultado de las actividades de análisis y evaluación de requerimientos.

Es utilizada como fuente de comunicación entre los clientes, usuarios finales,
analistas de sistemas, equipo de pruebas, y todo aquel involucrado en la
implementación del sistema. 

Debe contar con las siguientes características: Completa, Consistente, Verificable,
Rastreable, Precisa.

----

#### Matriz de Rastreabilidad
Es una tabla que permite relacionar cada requerimiento con otros elementos del desarrollo del software, de manera que podamos seguir su recorrido desde su origen hasta su implementación y verificación.

La idea central es poder responder preguntas como:
...
#### Matriz de Rastreabilidad: Ejemplo
Supongamos que estamos desarrollando un sistema para una biblioteca.
...
<tr>
<td>RF-01</td>
<td>El sistema deberá permitir registrar libros.</td>
</tr>
<tr>
<td>RF-02</td>
<td>El sistema deberá permitir registrar socios.</td>
</tr>
<tr>
<td>RF-03</td>
<td>El sistema deberá permitir realizar préstamos de libros.</td>
</tr>
<tr>
<td>RNF-01</td>
<td>El sistema deberá responder cada operación en menos de 2 segundos.</td>
</tr>
</tbody>
</table>
...
#### Matriz de Rastreabilidad: Ejemplo
Una matriz de trazabilidad podría ser:
...
<tr>
<td>RF-01</td>
<td>CU-01 Registrar libro</td>
<td>D-01</td>
<td><code>LibroController</code></td>
<td>CP-01</td>
</tr>
<tr>
<td>RF-02</td>
<td>CU-02 Registrar socio</td>
<td>D-02</td>
<td><code>SocioController</code></td>
<td>CP-02</td>
</tr>
<tr>
<td>RF-03</td>
<td>CU-03 Realizar préstamo</td>
<td>D-03</td>
<td><code>PrestamoController</code></td>
<td>CP-03</td>
</tr>
<tr>
<td>RNF-01</td>
<td>—</td>
<td>D-04</td>
<td>Configuración servidor</td>
<td>CP-04</td>
</tr>
</tbody>
</table>

Si no encontramos ningún requerimiento asociado, podría ser una señal de que tenemos funcionalidad innecesaria o de que falta documentar un requerimiento.
...
Esto permite ver que un requerimiento del usuario puede dar origen a varios requerimientos del sistema.

----

#### Matriz de Rastreabilidad: Utilidad
<!-- .slide: style="font-size: 0.80em" -->
1. **Trazabilidad hacia adelante**

Partimos del requerimiento y seguimos hacia su implementación:

**Requerimiento** → **Diseño** → **Código** → **Prueba**

Sirve para comprobar que todos los requerimientos fueron implementados y probados.

2. **Trazabilidad hacia atrás**

Partimos de un elemento del sistema y volvemos hacia el requerimiento que lo originó:

**Prueba** → **Código** → **Diseño** → **Requerimiento**

Sirve, entre otras cosas, para comprobar que cada elemento desarrollado tiene una razón de existir.

----

#### Matriz de Rastreabilidad: Utilidad
<!-- .slide: style="font-size: 0.90em" -->
Una matriz de trazabilidad permite principalmente:

- Verificar que todos los requerimientos están implementados.
- Verificar que todos los requerimientos tienen pruebas.
- Detectar requerimientos que quedaron sin implementar.
- Detectar funcionalidades que no corresponden a ningún requerimiento.
- Analizar el impacto de un cambio.
- Mantener la relación entre las distintas etapas del desarrollo.
- Facilitar las pruebas y la validación.
- Ayudar en auditorías y sistemas donde se necesita mucha documentación.
...
Algunas técnicas son más efectivas en algunas etapas de análisis de R que en otras:
...
<table>
  ...
  <tbody>
    <tr><td>1. Entrevistas y cuestionarios</td><td>X</td><td></td><td></td><td></td></tr>
    <tr><td>2. Sistemas Existentes</td><td>X</td><td>X</td><td></td><td></td></tr>
    <tr><td>3. Grabaciones de Video y Audio</td><td>X</td><td>X</td><td></td><td></td></tr>
    <tr><td>4. Lluvia de Ideas</td><td>X</td><td>X</td><td></td><td></td></tr>
    <tr><td>5. Arqueología de documentos</td><td>X</td><td>X</td><td></td><td></td></tr>
    <tr><td>6. Observación</td><td>X</td><td></td><td></td><td></td></tr>
    <tr><td>7. Prototipo no funcional</td><td>X</td><td>X</td><td>X</td><td></td></tr>
    <tr><td>8. Prototipo Funcional</td><td>X</td><td></td><td>X</td><td>X</td></tr>
    <tr><td>9. Análisis DOFA</td><td></td><td>X</td><td></td><td></td></tr>
    <tr><td>10. Cadena de Valor</td><td></td><td>X</td><td></td><td></td></tr>
    <tr><td>11. Modelo Conceptual</td><td></td><td>X</td><td>X</td><td></td></tr>
    <tr><td>12. Diagrama de Pescado</td><td>X</td><td>X</td><td>X</td><td></td></tr>
    <tr><td>13. Glosario</td><td>X</td><td>X</td><td>X</td><td>X</td></tr>
    <tr><td>14. Diagrama de actividad</td><td></td><td>X</td><td>X</td><td></td></tr>
    <tr><td>15. Casos de Uso</td><td>X</td><td>X</td><td>X</td><td>X</td></tr>
    <tr><td>16. Casa de Calidad o QFD</td><td></td><td></td><td></tds><td>X</td></tr>
    <tr><td>17. Lista de Verificación</td><td>X</td><td></td><td>X</td><td></td></tr>
    <tr><td>18. Mesa de trabajo / Workshop</td><td>X</td><td>X</td><td></td><td>X</td></tr>
  </tbody>
</table>
...
---
### H2. Sistemas existentes
<!-- .slide: style="font-size: 0.95em" -->
Consiste en analizar un sistema que ya está funcionando para descubrir requisitos del nuevo sistema o comprender cómo se realizan actualmente las actividades.
...
---
### H3. Grabaciones de video y audio

Consiste en utilizar grabaciones de las actividades de los usuarios para posteriormente analizarlas y descubrir información relevante.

Puede ser especialmente útil cuando:
- El proceso es complejo.
- Hay muchas actividades simultáneas.
- El analista no puede recordar todos los detalles.
- Es necesario revisar posteriormente una interacción.

---

### H4. Tormenta de ideas
...
---
### H7. Prototipo no funcional

Es una representación del sistema que no implementa realmente la funcionalidad, sino que permite visualizar cómo podría ser.

Por ejemplo:
- Bocetos o Sketch.
- Wireframes.
- Mockups.
- Pantallas navegables sin lógica real.
...
### H7. Prototipo no funcional
<!-- .slide: style="font-size: 0.95em" -->
Permite que los usuarios reaccionen ante algo concreto:
> "Esta pantalla debería tener
...
Por eso es muy útil para descubrir y aclarar requisitos, especialmente de interfaz.

---
### H8. Prototipo funcional

Es una versión parcial del sistema que implementa realmente algunas funcionalidades.

Permite que los usuarios interactúen con una versión aproximada del producto y proporcionen retroalimentación.

<small>
Por ejemplo, antes de desarrollar todo un sistema de turnos se implementa únicamente:

Iniciar sesión → seleccionar médico → solicitar turno.

Los usuarios pueden probarlo y detectar necesidades que no habían sido identificadas inicialmente.
</small>

---
### H9. Análisis DOFA

El análisis DOFA (Debilidades, Oportunidades, Fortalezas y Amenazas) permite analizar la situación de una organización o proceso.

No es una técnica de elicitación de requisitos en sentido estricto, pero puede ayudar a identificar necesidades y problemas que podrían transformarse en requisitos.
...
Esto puede llevar a un requisito:
- "El sistema deberá permitir importar automáticamente los datos de clientes."

---

### H10. Cadena de Valor

Permite analizar las actividades que generan valor dentro de una organización, identificando cómo se relacionan entre sí.

Sirve para comprender:
- Qué actividades se realizan.
- Cómo se relacionan.
- Dónde se genera valor.
- Dónde existen problemas o ineficiencias.
- Qué procesos podrían mejorarse mediante software.
...
Representa los conceptos importantes del dominio y las relaciones entre ellos.

Permite construir una visión común entre usuarios y desarrolladores sobre aquello que el sistema debe manejar.

Permite descubrir y aclarar:
- Entidades.
- Relaciones.
...
También llamado diagrama de Ishikawa o diagrama causa-efecto.

Permite analizar un problema identificando sus posibles causas.
...
RETRASO ─────────┼── Problemas de stock
                 │
                 └── Mala planificación

Es útil para comprender por qué existe una necesidad antes de convertirla en requisitos.
-->
...
Es un conjunto de términos y definiciones del dominio del problema.

Es especialmente importante cuando una organización utiliza palabras que pueden tener significados específicos.

Ayuda a evitar ambigüedades y a establecer un lenguaje común entre usuarios, clientes y desarrolladores.

---
### H14. Diagrama de actividad

Representa cómo se desarrolla un proceso o actividad, mostrando acciones, decisiones y flujos.

Puede ayudar a descubrir requisitos porque al representar un proceso aparecen:
- Actividades que el sistema debe soportar.
- Decisiones.
- Excepciones.
- Actores.
- Reglas del negocio.
...
Es una lista de aspectos que deben comprobarse sistemáticamente.

Puede utilizarse para evitar olvidar determinados requisitos o para comprobar características de los requisitos existentes.
...
Por tanto, es especialmente útil para revisar la calidad de los requisitos.

---

### H18. Mesas de Trabajo (Workshops)
