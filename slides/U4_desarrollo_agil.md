...
creación de métodos ágiles. Estos métodos:
  ...
  * Tienen la intencion de ofrecer software de forma rápida y
evolucionar velozmente para satisfacer las necesidades cambiantes.
...
3. Si es necesario, se refactoriza el código para hacerlo más fácil de entender
...
* Las pruebas se escriben como programas que se pueden ejecutar de forma automática. 
Las mismas comprueban que la funcionalidad implementada ess correctamente.
...
### Scrum se enfoca principalmente en la gestión del desarrollo, mientras que XP se enfoca mucho más en las prácticas técnicas de construcción del software.
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>Gestión del proyecto y del trabajo</td>
            <td>Desarrollo y calidad técnica del software</td>
        </tr>
        <tr>
            <td>Iteraciones</td>
            <td>Sprints, normalmente de 1 a 4 semanas</td>
            <td>Iteraciones cortas, generalmente de 1 a 2 semanas</td>
        </tr>
        <tr>
            <td>Planificación</td>
            <td>Sprint Planning</td>
            <td>Planificación basada en historias y prioridades</td>
        </tr>
        <tr>
            <td>Roles</td>
            <td>Product Owner, Scrum Master y Developers</td>
            <td>No define roles tan estrictamente</td>
        </tr>
        <tr>
            <td>Cliente</td>
            <td>El Product Owner representa al cliente</td>
            <td>El cliente participa activamente con el equipo</td>
        </tr>
        <tr>
            <td>Requisitos</td>
        ...
        <tr>
            <td>Entregas</td>
            <td>Incremento potencialmente entregable al final de cada Sprint</td>
            <td>Entregas frecuentes y pequeñas</td>
        </tr>
        <tr>
            <td>Programación</td>
            <td>No establece cómo programar</td>
            <td>Define prácticas concretas de programación</td>
        </tr>
        <tr>
            <td>Pruebas</td>
            <td>No prescribe técnicas específicas</td>
            <td>Pruebas automatizadas y TDD</td>
        </tr>
...
----
    ...
    <tbody>
        <tr>
            <td>Programación en parejas</td>
            <td>No la exige</td>
            <td>Práctica característica de XP</td>
        </tr>
        <tr>
            <td>Integración continua</td>
            <td>No es una regla de Scrum</td>
            <td>Práctica fundamental de XP</td>
        </tr>
        <tr>
            <td>Refactorización</td>
            <td>No la prescribe</td>
            <td>Práctica fundamental de XP</td>
        </tr>
        <tr>
            <td>Diseño simple</td>
            <td>No lo especifica</td>
            <td>Es una práctica de XP</td>
        </tr>
        <tr>
            <td>Feedback del cliente</td>
            <td>Principalmente durante la Sprint Review</td>
            <td>Muy frecuente y directo</td>
        </tr>
        <tr>
            <td>Cambios de requisitos</td>
            <td>Se incorporan al Product Backlog y se priorizan</td>
            <td>Se espera que los requisitos cambien frecuentemente</td>
        </tr>
    </tbody>
</table>
