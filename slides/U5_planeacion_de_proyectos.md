...
### Fijación de precio: Expectativa

**costo del desarrollo + ganancias para el diseñador**
...
1. **Introducción:** Objetivos y restricciones (presupuesto, tiempo, personal, etc) del proyecto.  
...
---
### (Nuevamente)..GESTIÓN DE PROYECTOS
![Proceso de Gestión de Proyectos](images/u5-gest-proy/proceso-gestion-proyectos.jpg)
...
Ejemplo, documento de requerimientos para el sistema
...
### calendarización en proyectos dirigidos por plan
1. Dividir el trabajo en tareas separadas y estimar el tiempo para
completar cada tarea. (Deben durar más de una semana y menos de dos meses. Sino, refinal nuevamente) 
2. Se debe coordinar para ejecutar las tareas en paralelo y reducir interferencias.
3. Evitar demoras en tareas críticas.
4. Actualizar cronograma acorde al avance.
...
### Diagrama de Gantt: Ejercicio
<!-- .slide: style="font-size: 0.85em" -->
Empleando el siguiente [Template](https://docs.google.com/spreadsheets/d/1Tnu5UtZQhVM_uzzPELXKLBhKlQyWKTmh78RaH5e1dkI/edit?gid=920878631#gid=920878631) completar y responder:
1. ¿Cuántas semanas son necesarias para completar el proyecto?
2. ¿Qué actividades pueden realizarse simultáneamente?
3. ¿Qué actividad o actividades tienen que esperar a que finalicen las dos actividades anteriores?
4. Si la actividad D — Diseño de la base de datos se retrasa 2 días, ¿se modifica necesariamente la fecha de finalización del proyecto? Justificar.
5. Si la actividad F — Implementación del backend se retrasa 3 días, ¿qué actividades se ven afectadas?
6. ¿Qué actividades deberían ser especialmente controladas por el director del proyecto?

----

### Diagrama de Gantt: Ejercicio

Tener en cuenta que existe una diferencia entre:
- **Duración de una tarea** → días laborables (no tener en cuenta fines de semana, feriados)
- **Duración del proyecto** → meses totales
...
![Tabla de Pert](images/u5-gest-proy/ejemplo-pert.jpg)

----

#### Pert
<!-- .slide: style="font-size: 0.95em" -->
Son las siglas de **Program Evaluation and Review Techique**, Técnica de Revisión y Evaluación de Programas.

Un proyecto está compuesto por actividades que deben realizarse en determinado orden. PERT permite representar esas actividades y calcular la duración esperada del proyecto, identificando además las actividades críticas.
...
ES, que es igual al número o resultado mayor de la terminación temprana de las actividades precedentes.
...
un sentido de propiedad y eso motiva más a completar la tarea.

---

### Requerimientos Funcionales e Historias de Usuario
<!-- .slide: style="font-size: 0.80em" -->
Un **requerimiento funcional** describe qué debe hacer el sistema:

- **RF-01:** El sistema deberá permitir registrar una observación de fauna indicando especie, fecha, ubicación y cantidad de individuos.

Una **historia de usuario** expresa una necesidad desde la perspectiva de un usuario:

- **HU-01:** Como observador de fauna, quiero registrar una observación indicando especie, fecha, ubicación y cantidad de individuos, para llevar un registro de los avistajes realizados.

Un requerimiento funcional puede dar origen a una historia de usuario, pero no hay una correspondencia obligatoria de 1 a 1.
...
Ejemplo: Gestionar observaciones de fauna
 - HU: Registrar observación
 - HU: Modificar observación
 - HU: Eliminar observación

---

### Planeación Ágil
<!-- .slide: style="font-size: 0.85em" -->
1. Una persona por grupo de **Avistaje de Fauna** cree una cuenta en [Jira](https://www.atlassian.com/es/software/jira)
2. Cree un **Proyecto** e invite a cada uno de sus compañeros y a la docente edmealiciardi@gmail.com
3. Dentro del proyecto crear las diferentes **Features** y las **tareas** necesarias para desarrollarla
...
2. Compartirá el link a los estudiantes o mediante QR -> [Link](https://planningpokeronline.com/IyIZ1ufbkNh4a7sdgLrF/)
...
De la tabla obtendremos que el **nivel de complejidad** para cada informe es **difícil**.
