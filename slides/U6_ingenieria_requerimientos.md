...
<tr>
<td>3. Lenguajes de descripción de Diseño</td>
...
<tr>
<td>5. Especificaciones matemáticas</td>
...
---
### 1. Especificación en lenguaje natural
...
### LN: Guías para la redacción de los requerimientos
...
### LN: Requerimientos de bomba de insulina
<!-- .slide: style="font-size: 0.80em" -->
...
### 3. Lenguajes de descripción de diseño

Aquí se utiliza un lenguaje específico para describir la estructura o comportamiento del sistema de manera más formal/abstracta.

Por ejemplo, utilizando una notación tipo AADL podríamos describir componentes del sistema:

```
system LoginSystem
    components
        server: system LoginServer;
        database: data UserDatabase;
...
### 3. Lenguajes de descripción de diseño
Es un lenguaje especializado, con una sintaxis y semántica definidas, para representar aspectos del sistema.

Otros ejemplos:

- AADL → arquitectura de sistemas.
- Acme → descripción de arquitecturas de software.
- Wright → especificación de comportamiento y comunicación de componentes.
- xADL → descripción de arquitecturas.

---

### 4. Notaciones gráficas

El mismo requisito puede representarse mediante un modelo gráfico, empleando por ejemplo UML (Unified Modeling Language)
- Caso de uso
- Diagrama de secuencia

En este caso, el requisito se expresa mediante elementos gráficos, aunque normalmente se complementa con texto.
